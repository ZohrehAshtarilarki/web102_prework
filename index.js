...
// use reduce() to sum up the pledged amounts
...
// set its inner HTML to the number of games
...
// Add event listener to search as you type
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. ${numUnfundedGames > 0 ? `Currently, ${numUnfundedGames} ${numUnfundedGames === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!` : "All games are fully funded! Thank you for your support!"}`;
